...
INSERT INTO public.services VALUES (2, 'Hair massage');
INSERT INTO public.services VALUES (3, 'Oral');
...
--
-- Name: appointments cid_fk; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.appointments
    ADD CONSTRAINT cid_fk FOREIGN KEY (customer_id) REFERENCES public.customers(customer_id);


--
-- Name: appointments sid_fk; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.appointments
    ADD CONSTRAINT sid_fk FOREIGN KEY (service_id) REFERENCES public.services(service_id);
